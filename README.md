...
## 概要
ParkingHubは、会社駐車場の利用者および車両、違反記録の管理、駐車許可証発行・注意文書作成などを効率化するWebシステムです。
従来のExcel管理から脱却し、社内サーバ上でDocker環境で安定運用を目指します。

★本アプリはクリーンアーキテクチャでTDDの方針で開発します★
...
- **データベース**: PostgreSQL  
- **インフラ**: 社内サーバ上にDockerコンテナを立て、コンテナ内でサーバを起動します。  
- **アクセス**: 社内ネットワークのみ
